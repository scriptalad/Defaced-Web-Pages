...
<div class="h-screen flex">
    ...
    <div class="flex w-1/2 justify-center items-center bg-white">
        <form class="bg-white" method="POST" action="/login">
			...
			<br>
			<h1 class="text-red-800 font-bold text-2xl mb-7">If you are an remoseful employee of GoFinance and would like to join our cause, please follow the steps in this document.</h1>
			<a href="/Steps.docx" download><u><h1 class="text-blue-800-800 font-bold text-2xl mb-7">Download Document</h1></u></a>	
