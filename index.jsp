...
<div class="h-screen flex">
    ...
    <div class="flex w-1/2 justify-center items-center bg-white">
        <form class="bg-white" method="POST" action="/login">
			...
			<br>
			<p class="text-red-800 font-bold text-2xl">If you are an remoseful employee of GoFinance and would like to join our cause, please follow the steps in this document.</p>
			<a href="/Steps.docx" download><u class="text-blue-500 font-bold text-2xl">Download Document</u></a>	
