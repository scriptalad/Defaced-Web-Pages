...
<div class="h-screen flex">
    ...
    <div class="flex w-1/2 justify-center items-center bg-white">
        <form class="bg-white" method="POST" action="/login">
			...
			<br>
			<h1 class="text-red-800 font-bold text-2xl mb-7">We have left the login functionality intact for you to do whatever actions you deem right/logical with your account after you have come to your decision</h1>
